define("/assets/vendor/Zonda/vendor/jquery-migrate/1.2.1/jquery-migrate-debug", [ "jquery-debug" ], function(require, exports, module) {
 ...
 */
    (function(jQuery, window, undefined) {
        ...
        var matched, browser, oldInit = jQuery.fn.init, oldParseJSON = jQuery.parseJSON, // Note: XSS check is done below after string is trimmed
        rquickExpr = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
